...
export default function CreatePoint(props) {
  ...
  const [hasServices, setHasServices] = useState(t("yes"))
  const [forChildren, setForChildren] = useState(t("yes"))
      ...
      <Provider style={styles.container}>
        ...
        <ScrollView>
          <View style={styles.form}>
            ...
            <View style={styles.flexContent}>
              <Text style={styles.defTitle}>{t("isforchildren")}:</Text>
              <Picker
                selectedValue={forChildren}
                style={styles.pickerElement}
                onValueChange={(itemValue) => setForChildren(itemValue)}
              >
                <Picker.Item
                  label={t("yes")}
                  value={t("yes")}
            ...
            <View style={styles.flexContent}>
              <Text style={styles.defTitle}>{t("hasRestaurant")}:</Text>
              <Picker
                selectedValue={hasServices}
                style={styles.pickerElement}
                onValueChange={(itemValue) => setHasServices(itemValue)}
              >
                <Picker.Item
                  label={t("yes")}
                  value={t("yes")}
